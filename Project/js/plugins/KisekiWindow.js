...
(function (KisekiWindow) {
    ...
    var Window_KisekiStatus = (function (_super) {
         ...
         * @override
         */
        Window_KisekiStatus.prototype.update = function () {
         ...
         * @override
         */
        Window_KisekiStatus.prototype.refresh = function () {
            this.saveLastStates();
         ...
         * @override
         */
        Window_KisekiStatus.prototype.standardPadding = function () {
            return 0;
        };
        /**
         * @override
         */
        Window_KisekiStatus.prototype.spacing = function () {
            return 0;
        };
        /**
         * @override
         */
        Window_KisekiStatus.prototype.maxItems = function () {
            return $gameParty.members().length;
        };
        /**
         * @override
         */
        Window_KisekiStatus.prototype.maxCols = function () {
            return this.maxItems();
        };
        /**
         * @override
         */
        Window_KisekiStatus.prototype.drawItem = function (index) {
         ...
         * @override
         */
        Window_KisekiStatus.prototype.itemRect = function (index) {
            return new Rectangle(areaWidth * index, 20, areaWidth, Window_KisekiStatus.WINDOW_HEIGHT);
        };
        /**
         * 状態が変わったメンバーが存在するか？
         */
        Window_KisekiStatus.prototype.isStatesChanged = function () {
            var members = $gameParty.members();
            for (var _i = 0, members_1 = members; _i < members_1.length; _i++) {
                var actor = members_1[_i];
         ...
         * メンバーの状態を保存する
         */
        Window_KisekiStatus.prototype.saveLastStates = function () {
            this.lastActorInfo = {};
         ...
         * メンバーの状態テキストを作成する
         */
        Window_KisekiStatus.prototype.createInfoList = function (actor) {
            return [actor.hp, actor.mp, actor.tp].join();
        };
        /**
         * 表示を更新する
         */
        Window_KisekiStatus.prototype.updateVisivility = function () {
         ...
         * 小さい顔グラを表示する
         */
        Window_KisekiStatus.prototype.drawActorMiniFace = function (actor, x, y) {
         ...
         * 顔グラの端っこを消去する
         */
        Window_KisekiStatus.prototype.removeEdge = function (bitmap) {
            for (var i = 0; i < 22; i++) {
         ...
         * HPゲージを描画する
         */
        Window_KisekiStatus.prototype.drawActorHpGauge = function (actor, x, y, width) {
         ...
         * MPゲージを描画する
         */
        Window_KisekiStatus.prototype.drawActorMpGauge = function (actor, x, y, width) {
         ...
         * TPゲージを描画する
         */
        Window_KisekiStatus.prototype.drawActorTpGauge = function (actor, x, y, width) {
            if (!showTp) {
                return;
            }
         ...
         * ゲージを描画する
         */
        Window_KisekiStatus.prototype.drawActorGauge = function (x, y, width, rate, color1, color2) {
         ...
         * 背景を描画する
         */
        Window_KisekiStatus.prototype.drawBg = function (actor, x, y) {
         ...
         * フレームを描画する
         */
        Window_KisekiStatus.prototype.drawFrame = function (actor, x, y) {
            var frameImage = ImageManager.loadSystem('Actor_bg2');
            this.contents.blt(frameImage, 0, 0, frameImage.width, frameImage.height, x, y, frameImage.width, frameImage.height);
        };
        /** ウィンドウの高さ */
        Window_KisekiStatus.WINDOW_HEIGHT = 70;
        /** ゲージの高さ */
        Window_KisekiStatus.GAUGE_HEIGHT = 2;
        /** 顔グラのサイズ */
        Window_KisekiStatus.SMALL_FACE_IMAGE_SIZE = 48;
        return Window_KisekiStatus;
    }(Window_Selectable));
